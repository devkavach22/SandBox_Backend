...
await User.create({
name:     "Admin",
email:    "[kavachadmin@gmail.com](mailto:kavachadmin@gmail.com)",
...
method:      "POST",
description: "Authenticate in KonvertHR and get a token",
pricePerCall: 2,
isDemo:      true,
sampleBody: {
user_name: "Komal"
...
method:      "POST",
description: "Check whether a GST number is valid and get company details",
pricePerCall: 5,
isDemo:      true,
sampleBody: {
